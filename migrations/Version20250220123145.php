 ...
 */
final class Version20250220123145 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categorie (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, ordre INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, salle_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, login VARCHAR(255) DEFAULT NULL, mdp VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, comment VARCHAR(50) NOT NULL, date DATE DEFAULT NULL, heure DATETIME DEFAULT NULL, date_suppr DATE DEFAULT NULL, INDEX IDX_C7440455DC304035 (salle_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE composer (id INT AUTO_INCREMENT NOT NULL, avoir_id INT DEFAULT NULL, famille_id INT DEFAULT NULL, INDEX IDX_987306D8C36D46DB (avoir_id), INDEX IDX_987306D897A77B84 (famille_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE famille (id INT AUTO_INCREMENT NOT NULL, produit_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, nb_min INT NOT NULL, nb_max INT NOT NULL, INDEX IDX_2473F213F347EFB (produit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ligne_commande (id INT AUTO_INCREMENT NOT NULL, produit_id INT NOT NULL, taille_id INT DEFAULT NULL, commande_id INT NOT NULL, numero_ordre INT DEFAULT NULL, quantite INT NOT NULL, prix DOUBLE PRECISION NOT NULL, numero_menu INT DEFAULT NULL, INDEX IDX_3170B74BF347EFB (produit_id), INDEX IDX_3170B74BFF25611A (taille_id), INDEX IDX_3170B74B82EA2E54 (commande_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, sous_categorie_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, en_ligne TINYINT(1) NOT NULL, est_remise TINYINT(1) NOT NULL, valeur DOUBLE PRECISION DEFAULT NULL, INDEX IDX_29A5EC27BCF5E72D (categorie_id), INDEX IDX_29A5EC27365BF48 (sous_categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE composer ADD CONSTRAINT FK_987306D8C36D46DB FOREIGN KEY (avoir_id) REFERENCES avoir (id)');
        $this->addSql('ALTER TABLE composer ADD CONSTRAINT FK_987306D897A77B84 FOREIGN KEY (famille_id) REFERENCES famille (id)');
        $this->addSql('ALTER TABLE famille ADD CONSTRAINT FK_2473F213F347EFB FOREIGN KEY (produit_id) REFERENCES produit (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE composer DROP FOREIGN KEY FK_987306D8C36D46DB');
        $this->addSql('ALTER TABLE composer DROP FOREIGN KEY FK_987306D897A77B84');
        $this->addSql('ALTER TABLE famille DROP FOREIGN KEY FK_2473F213F347EFB');
